...
| `ldpc_codec` | 1.0.3 | rtl | `cbb/ldpc_codec` | certified | — | — | — |
| `lfsr_gen` | 1.0.1 | primitive | `cbb/lfsr_gen` | certified | — | — | — |
| `ofdm_tx_top` | 1.0.1 | rtl | `cbb/ofdm_tx_top` | certified | — | — | — |
| `pulse_merge` | 1.0.1 | rtl | `cbb/pulse_merge` | certified | — | — | board-validation |
...
| `stream_elastic_pipeline` | 1.0.1 | rtl | `cbb/stream_elastic_pipeline` | certified | — | — | board-validation |
