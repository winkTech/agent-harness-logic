// ============================================================================
// Channel Estimation Scoreboard — 比对 H_est 输出
// ============================================================================

class chEst_scoreboard extends generic_scoreboard;

    `uvm_component_utils(chEst_scoreboard)

    function new(string name, uvm_component parent);
        super.new(name, parent);
        golden_fname = "expected_h_est.bin";
    endfunction
    ...
    virtual function bit compare_item(axi_stream_seq_item item, int expected);
        ...
        if ((diff_i > 2) || (diff_i < -2) || (diff_q > 2) || (diff_q < -2)) begin
